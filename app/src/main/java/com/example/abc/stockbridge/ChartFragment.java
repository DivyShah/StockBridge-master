...
public class ChartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buy = (TextView)rootview.findViewById(R.id.buybtc);



        //small_tag=(TextView)findViewById(R.id.small_tag);
        display_coin=(TextView)rootview.findViewById(R.id.display_coin);
        display_difference=(TextView)rootview.findViewById(R.id.dispaly_difference);
        one_hour = (TextView) rootview.findViewById(R.id.one_hour);
        one_day = (TextView) rootview.findViewById(R.id.one_day);
        one_week = (TextView)rootview. findViewById(R.id.one_week);
        one_month = (TextView)rootview. findViewById(R.id.one_month);
        six_month=(TextView)rootview.findViewById(R.id.six_month);
        three_month=(TextView)rootview.findViewById(R.id.three_month);
        one_year = (TextView) rootview.findViewById(R.id.one_year);
        mChart=(LineChart)rootview.findViewById(R.id.linechart);
        below_price=(TextView)rootview.findViewById(R.id.below_price);

       /* allexchanges=(Button)rootview.findViewById(R.id.all_exchanges);
        ...
        cryptoCurrencyCall.enqueue(new Callback<CryptoCurrency>() {
            ...
            public void onResponse(Call<CryptoCurrency> call, Response<CryptoCurrency> response) {
                ...
                if(response.isSuccessful()) {
                    if (whichType.equals("one_hour")) {
                        if (marketCap == null) {
                            Toast.makeText(getActivity(), "MarketCap is null from response", Toast.LENGTH_SHORT).show();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId())
                {
                    ...
                    case R.id.coin_secure:
                        ...
                        {
                            Toast.makeText(getActivity(),"hello coinsecure",Toast.LENGTH_SHORT).show();
                            return true;
                        }
                        else {
                    ...
                    case R.id.unocoin:
                        Intent intent1= new Intent(getActivity(),All_Exchange_Activity.class);
